...
#define mainColors ColorChange<TrWipe<500>,Rgb<100,100,150>,GreenYellow,Chartreuse,Green,SpringGreen,Cyan,DeepSkyBlue,DodgerBlue,Blue,Violet,Indigo,Magenta,HotPink,Red,OrangeRed,DarkOrange,Orange,Rgb<255,160,0>,Yellow>
#define flickerColors ColorChange<TrWipe<500>,Rgb<50,50,75>,Rgb<54,128,3>,Rgb<28,128,0>,Rgb<0,128,0>,SpringGreenDark,DeepSkyBlue,DeepSkyBlueDark,DodgerBlueDark,Rgb<0,0,128>,VioletDark,IndigoDark,MagentaDark,Rgb<128,18,59>,Rgb<128,0,0>,Rgb<128,14,0>,Rgb<128,34,0>,Rgb<128,48,0>,Rgb<84,60,0>,Rgb<128,128,0>>
