...
typedef Rgb<0, 68, 128> DeepSkyBlueDark;
typedef Rgb<2, 72, 255> DodgerBlue;
typedef Rgb<0, 36, 128> DodgerBlueDark;
...
typedef Rgb<120,20,235> Indigo;
typedef Rgb<60,10,170> IndigoDark;
...
typedef Rgb<255, 0, 255> Magenta;
typedef Rgb<139, 0 ,139> MagentaDark;
...
typedef Rgb<0, 128, 28> SpringGreenDark;
typedef Rgb<14, 57, 118> SteelBlue;
typedef Rgb<255, 31, 15> Tomato;
typedef Rgb<138, 20, 226> Violet;
typedef Rgb<68, 10, 113> VioletDark;
typedef Rgb<255, 255, 255> White;
typedef Rgb<255, 255, 0> Yellow;
